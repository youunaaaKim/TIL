...
while True:
    ...
    # dx, dy = targetBall_x - whiteBall_x, targetBall_y - whiteBall_y
    ...
    # 목적구가 흰 공을 중심으로 4사분면에 위치했을 때 각도를 재계산
        ...
        radian = math.atan(width / height)
        angle = (290 / math.pi * radian) + 271  # 180 / 4라운드 통과 각도 290 / 271
...
# 잔략 : 모든 공의 경우의 수 계산
    ...
    #     angle = (180 / math.pi * radian) + 90 # 90
